...
void return_to_liang()
{
        ...
        if (playerp(me))
        {
                ...
                message_vision("忽然一陣狂風卷着沙石向你捲來，你連忙拿手遮起眼睛，狂風逐漸平靜下來"
                               "你覺得身上好像少了點什麼？又說不上來。\n", me);
        } else
        {
                message("vision", "忽然一陣狂風卷着沙石捲來，把地上一張紅色的袈裟卷上天空"
                                  "消失了。\n", me);
        }
