...
inherit ROOM;
inherit F_SAVE;
#include <ctime_format_func.h>    // 某些MUD里沒有這個函數：ctime_format()，把它寫成：return ctime(time()); 即可。
//#include <set_del_color_func.h> // 某些MUD里沒有這兩個 s_efun:  setcolor(), delcolor().
...
"**********************************************************
    ...
    "HIY"押註：   <bet 數量 to da|xiao|dan|shuang|baozi>"NOR"
