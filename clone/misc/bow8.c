...
void create()
{
        ...
        if(clonep())
                ...
                set("long",
HIR"天下第一神弓――落日弓，據聞自后羿射日後，天下已無人能拉開此弓。\n
此弓一出，直可驚天地，泣鬼神！！！\n"NOR);
                set("unit", "把");
                set("value", 200000);
                set("consistence", 85);
                  ...
                  || random(query("combat_exp", me))>query("combat_exp", ob)*2 )
                     {
                              if (damage > 2000)
                                message_vision(HIY"“嗖”地一聲，一枚"HIW"羽箭從"HIR
                                                   ...
                                                   + HIY"飛來，"HIR"“噗嗤”"HIY"一聲扎在$N"HIR"額頭"HIY"上！\n"NOR,
                                                   ob);
                              else if (damage > 1500)
                                message_vision(HIY"“嗖”地一聲，一枚"HIW"羽箭從"HIR
                                                   + exits_name[exits_reverse(what)]
                                                   + HIY"飛來，"HIR"“噗嗤”"HIY"一聲扎在$N"HIR"胸口"HIY"上！\n"NOR,
                                                   ob);
                              else if (damage > 1000)
                                message_vision(HIY"“嗖”地一聲，一枚"HIW"羽箭從"HIR
                                                   + exits_name[exits_reverse(what)]
                                                   + HIY"飛來，"HIR"“噗嗤”"HIY"一聲扎在$N"HIR"肩膀"HIY"上！\n"NOR,
                                                   ob);
                              else if (damage > 500)
                                message_vision(HIY"“嗖”地一聲，一枚"HIW"羽箭從"HIR
                                                   + exits_name[exits_reverse(what)]
                                                   + HIY"飛來，"HIR"“噗嗤”"HIY"一聲扎在$N"HIR"小腿"HIY"上！\n"NOR,
                                                   ob);
                              else
                                message_vision(HIY"“嗖”地一聲，一枚"HIW"羽箭從"HIR
                                                   + exits_name[exits_reverse(what)]
                                                   + HIY"飛來，"HIR"“噗嗤”"HIY"一聲扎在$N"HIR"手臂"HIY"上！\n"NOR,
                                                   ob);
