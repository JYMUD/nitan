...
string *nature_message = ({
        ...
        "你放眼望去，一群海豚尾隨着船，正在跳躍嬉戲，海面波光粼粼，甚是美麗。\n",
        "幾聲驚雷過後，天空突然下起雨來，海浪滔天，船身劇烈地搖晃着。\n",
        "風雨過後，天空突然放晴，一群海鷗從天邊飛來，映襯着遠出的彩虹，真是人間美景。\n",
...
void create()
{
        ...
        else
        {
                ...
                set("unit", "艘");
                set("material", "wood");
                set("no_get", "船夫(chuanfu)喝道：好傢夥，這你也想扛在肩上？\n");
                ...
                if (query("running"))
                {
                        ...
                        {                
                                ...
                                if ((time() - last_update_boss >= 1800) && random(4) == 7 )
                                {
                                        ...
                                        {
                                                message_vision(HIB "突然，風起浪涌，只見天空一團黑霧飄過，船身劇烈晃動，恍惚間，一隻巨獸已經站在"
                                                               "你面前。\n" NOR, this_object()); 
                        ...
                        set("long", HIC "\n船夫(chuanfu)吆喝道：我們的船正在等待中(開船剩餘" + sprintf("%d", left_time) + "分鐘)，你可以先在船上休息（enter）。\n" NOR);
