...
void create()
{
        ...
        if( clonep() )
                ...
                set("long","這是一輛半新不舊的大車，車上坐着一個半老不老的車夫。
...
武當解劍岩   (wudang)     /d/wudang/jiejianyan
...
梅庄大門     (meizhuang)  /d/meizhuang/gate
