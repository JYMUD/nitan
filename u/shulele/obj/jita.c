...
int do_tan(string arg)
{
	...
	switch( random(22) ) {
		...
		break;
                case 1:
                message("channel:chat",HIY"〖"+me->query("name")+"笑傲江湖演唱會〗："HIC"我的熱情，好象一把火，燃燒了整個沙漠，太陽見了我，也會躲着我～～\n"NOR,users());
		break;
                case 2:
		...
		break;
		case 16:
		message("channel:chat",HIY"〖"+me->query("name")+"笑傲江湖演唱會〗："HIC"讓我將你心兒摘下，試着讓它漫漫融化，看我在你心中是否仍完美瑕～～\n"NOR,users());
		break;
		case 17:
