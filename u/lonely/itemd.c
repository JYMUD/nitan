...
int receive_miss(object me, object item)
{
        ...
        message("vision", HIM "一道彩虹划過天際，" + me->name() +
...
int do_enchase(object me, object item, object tessera)
{
        ...
        */
        ...
        if( tessera->is_rune() && query("enchase/rune" + query("enchase/SN", tessera), item) )
                return notify_fail(item->name() + "上的凹槽里已經鑲嵌此符文,再鑲嵌會產生魔性衝突。\n");
...
mixed weapon10lv_hit_ob(object me, object victim, object weapon, int damage_bonus)
{
        ...
        case "metal":
                ...
                case 0:
                        ...
                        break;
                case 1:
                        msg = HIY + weapon->name()+HIY"一飛衝天，片刻時間化作無數的"HIY + weapon->name()+HIY"金錢撒地般的射向$n。\n"NOR;
                        break;
                default:
        ...
        case "earth":
                ...
                case 0: 
                        ...
                        break;
                case 1:
                        msg = YEL + weapon->name()+ YEL"急速的划過土石之緣，帶動山石之雨，咆哮着令人心膽俱裂的震天怒響擊向$n。 \n"NOR;
                        break;
                default:
