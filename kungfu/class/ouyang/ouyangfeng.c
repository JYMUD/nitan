...
//                command("say 蛇谷中的蛇兒，你可以隨意捕捉。好好修鍊毒技，莫要墮了西毒的威名！");
//        staff = new("/d/baituo/obj/lingshezhang");
//        staff->move(me);
             ob->move(this_object());

message_vision("$N點點頭道：蛇谷中的蛇兒，你可以隨意捕捉。好好修鍊毒技，莫要墮了西毒的威名！\n", this_object(), me);
...
addn("family/gongji", -cost, me); 
        ...
        if( lv < 80 ) {
                command("say 憑你這點使毒本事，想進蛇谷還早得很。乖乖的在莊裡修鍊！");
                return 1;
        }
...
string ask_lingshe()
{
        ...
        message_vision(CYN"$N撮唇作嘯，袖中緩緩游出一條銀色小蛇，對着$n搖頭擺尾，似在示意問好。\n"NOR,
        this_object(), me);
