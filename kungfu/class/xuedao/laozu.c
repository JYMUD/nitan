...
mixed ask_skill8()
{
        ...
        command("grin");
        command("say 這招的要領就是義無返顧，拚死一攻，記住了嗎？");
...
mixed ask_skill9()
{
        ...
        message_vision(HIY "$n" HIY "望着$N" HIY "乾笑了數聲，說道：“想不到居然那麼"
