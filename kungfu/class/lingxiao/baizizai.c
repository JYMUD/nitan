...
void create()
{
        ...
        set("inquiry",([
                "風回雪舞" : "這招你讓吾兒教你便成，用不着來麻煩老夫。",
                "雪花六齣" : "這招你讓吾兒教你便成，用不着來麻煩老夫。",
                "劍氣封喉" : (: ask_skill1 :),
                "三連環"   : (: ask_skill2 :),
                "神倒鬼跌三連環" : (: ask_skill2 :),
        ]));
        ...
        set("no_teach", ([
                ...
                "白自在又道：這劍法雖不及我雪山劍法精妙，但也頗具威力，玄素庄莊主石清與我交好，他"
                "可傳你此劍法。",
        ]));
...
mixed ask_skill1()
{
        ...
        if (me->query_skill("xueshan-jian", 1) < 160)
                return "你雪山劍法尚未修鍊得精深，沒法用這招。";

        message_vision( HIY "$n" HIY "哈哈一笑，對$N" HIY "贊道：“不錯，"
                        "不錯，真不愧是老夫的徒\n弟。今日老夫高興，傳你這"
                       "招，可要看好了！”$n" HIY "話音剛落\n隨即一聲清嘯"
