...
void init()
{
        ...
        {
                command("say 好傢夥，原來你偷了我的神木王鼎！受死吧！");
                kill_ob(me);
                return;
        }
        */
...
int ask_book()
{
       ...
       if( query("canbook", me) == 1 && (!present("yijinjing",me))){
                tell_object(me,"丁春秋說道：“好徒兒，還沒參透這本易筋經的奧秘么？\n");
                tell_object(me,"那好吧。這本副本給你，拿回去好好參悟吧！\n");
                tell_object(me,"徒兒你一定要記住，千萬配合神木王鼎一起修鍊，要不然很容易走火入魔。”\n");
