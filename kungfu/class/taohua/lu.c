...
void attempt_apprentice(object ob)
{
        ...
        */
        ...
        {
                command("say 一位異人曾在本庄花廳留詩半闕，如果你能補全，也不枉來歸雲庄一遭");
                message_vision("陸莊主凝視着$N，說道：快把你的下闕大聲朗誦(recite)出來吧。\n",
                               this_player());
...
int do_recite(string arg)
{
        ...
        if (arg == "無人爭曉渡殘月下寒沙")
        {
                ...
                {
                        command("sigh");
                        command("say " + "卿本佳人，奈何自宮，本庄與東廠概無關聯，你去吧！");
                        return 0;
                }
...
mixed ask_skill1()
{
        ...
        message_sort(HIY "\n$n" HIY "對着$N" HIY "點了點頭，說道：“我給你演示"
                     "一遍，可看仔細了！”話音剛落，頓時只見$n" HIY "雙掌交疊雲"
                     "貫而出，激蕩出無數圈勁氣，一環環向$N" HIY "斫去，招數當真"
                     "精奇無比。\n\n" NOR, me, this_object());
