...
int ask_jiuyin()
{
                 ...
                 && query("family/master_id", me) == "ouyang feng" )
        {
                if( query("combat_exp", me)>500000 && present("mask_jiuyin",me) )
                {
                        ...
                        message_vision(HIY "黃蓉眼中閃過一絲狡黠的神色：“你想知道真經的解釋么？好吧，我說給你聽便是。”\n", me);
                        ...
                        message_vision("突然間，$N反手啪啪啪連打自己三個耳光，雙手撐地，倒立了起來，全身真氣逆游亂走 \n"NOR, me);
                        if (random(5) == 3)
                        {
                        ...
                        return 1;
                } else  return notify_fail("黃蓉白了你一眼：“就你這點微末道行，想學九陰真經？也不怕被人笑掉大牙么？”\n");
        } else return 0;
}
