...
mixed ask_wldh()
{
        ...
        return CYN"原來你是為了聚賢庄武林大會的事情而來的。" NOR;
}
...
int say_msg(object me, int index)
{
        ...
        case(6):
                ...
                break;
        case(7):
                message_vision(CYN"$N說道：第一件事，是把這封信送給徐長老。我在信中已經說明了我不去參加聚賢庄武林大會的理由。\n"NOR, this_object(), me);
                ...
                break;
        case(8):
                message_vision(CYN"$N說道：第二件事，是請你找機會進入聚賢庄，以喬峰的性格，他一定會在聚賢庄出現的，喬峰現在被千夫所指，一定很需要幫忙。\n"NOR, this_object(), me);
...
mixed ask_skill5()
{
        ...
        if( query("can_perform/duanjia-jian/lian", me) )
                return "你不是已經學會了五絕劍么？你要是有疑問我可答不了你。";
