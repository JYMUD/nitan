...
void create()
{
        ...
        set("inquiry", ([
                ...
                "三黃寶臘丹" : "等你學好了煉丹術，以後自己製吧。",
                "玉清散"     : "嗯...等你通曉了煉丹術的奧妙，自己慢慢製吧。",
                "繞指柔劍"   : "唉，你去問問你莫師兄把......",
        ]));
...
void attempt_apprentice(object ob)
{
        ...
        if (ob->query_skill("taoism", 1) < 120)
        {
                ...
                command("say " + RANK_D->query_respect(ob) + "還是多研究研究道學心法吧。  （需要道學心法120級）");
                return;
        }
        ...
        if (ob->query_int() < 32)
        {
                ...
                command("say " + RANK_D->query_respect(ob) + "的悟性還大有潛力可挖，還是請回吧。  （需要後天悟性32點）");
                return;
        }
...
mixed ask_skill1()
{
        ...
        if( query("family/gongji", me)<800 )
                return "你為我武當派效力還不夠，這招我先不忙傳你。  （需要800點門派貢獻）";

        if( query("shen", me)<150000 )
                return "你行俠仗義的事情做的還很不夠，我不能傳你絕招！  （需要150000點正氣）";

        if (me->query_skill("taiji-shengong", 1) < 100)
                return "你的太極神功修為太淺，修練好了再來吧。  （需要太極神功100級）";

        if( query("max_neili", me)<1500 )
                return "你的內力修為太淺，修練高了再來吧。  （需要內力1500點）";
...
mixed ask_skill2()
{
        ...
        if( query("family/gongji", me)<300 )
                return "你為我武當派效力還不夠，這招我先不忙傳你。  （需要300點門派貢獻）";

        if( query("shen", me)<100000 )
                return "你行俠仗義的事情做的還很不夠，我不能傳你絕招！  （需要100000點正氣）";

        if (me->query_skill("taiji-quan", 1) < 150)
                return "你的太極拳修為太淺，修練好了再來吧。  （需要太極拳150級）";

        if( query("max_neili", me)<1200 )
                return "你的內力修為太淺，修練高了再來吧。  （需要內力1200點）";
...
mixed ask_skill4()
{
        ...
        if( query("family/gongji", me)<400 )
                return "你為我武當派效力還不夠，這招我先不忙傳你。  （需要400點門派貢獻）";

        if( query("shen", me)<120000 )
                return "你行俠仗義的事情做的還很不夠，我不能傳你絕招！  （需要120000點正氣）";
...
mixed ask_skill5()
{
        ...
        if( query("family/gongji", me)<500 )
                return "你為我武當派效力還不夠，這招我先不忙傳你。  （需要500點門派貢獻）";
...
mixed ask_skill6()
{
        ...
        if( query("family/gongji", me)<3000 )
                return "你為我武當派效力還不夠，這招我不忙傳你。  （需要3000點門派貢獻）";

        if( query("shen", me)<250000 )
                return "你行俠仗義的事情做得還不夠多，我不能放心傳你絕招！  （需要250000點正氣）";

        if (me->query_skill("taiji-quan", 1) < 250)
                return "你的太極拳法還不到家，要多練練！  （需要太極拳250級）";

        if (me->query_skill("taiji-shengong", 1) < 300)
                return "你的太極神功還不到家，好好修行吧！  （需要太極神功300級）";

        if (me->query_skill("taoism", 1) < 300)
                return "你的道學心法研究的還不夠明白，要下功夫苦學才是！  （需要道學心法300級）";

        if( query("max_jingli", me)<1000 )
                return "你的精力不濟，就算傳給你太極圖你也難以運用。  （需要精力1000點）";
...
mixed ask_skill7()
{
        ...
        if( query("shen", me)<80000 )
                return "你行俠仗義的事情做的還很不夠，我不能傳你絕招！  （需要80000點正氣）";

        if (me->query_skill("taiji-jian", 1) < 80)
                return "你的太極劍法還不到家，要多練練！  （需要太極劍法80級）";
...
mixed ask_skill8()
{
        ...
        if (me->query_skill("taiji-jian", 1) < 60)
                return "你的太極劍法還不到家，要多練練！  （需要太極劍法60級）";
...
mixed ask_skill9()
{
        ...
        if( query("family/gongji", me)<600 )
                return "你為我武當派效力還不夠，這招我先不忙傳你。  （需要600點門派貢獻）";

        if( query("shen", me)<100000 )
                return "你行俠仗義的事情做的還很不夠，我不能傳你絕招！  （需要100000點正氣）";

        if (me->query_skill("taiji-jian", 1) < 150)
                return "你的太極劍法還不到家，要多練練！  （需要太極劍法150級）";
...
mixed ask_skill10()
{
        ...
        if (me->query_skill("taiji-jian", 1) < 160)
                return "你的太極劍法還不到家，要多練練！  （需要太極劍法160級）";
...
mixed ask_skill11()
{
        ...
        if( query("family/gongji", me)<2000 )
                return "你為我武當派效力還不夠，這招我先不忙傳你。  （需要2000點門派貢獻）";

        if( query("shen", me)<120000 )
                return "你行俠仗義的事情做的還很不夠，我不能傳你絕招！  （需要120000點正氣）";

        if (me->query_skill("taiji-jian", 1) < 180)
                return "你的太極劍法還不到家，要多練練！  （需要太極劍法180級）";
...
mixed ask_skill12()
{
        ...
        if (me->query_skill("taiji-jian", 1) < 1000)
                return "你的太極劍法還不到家，要多練練！  （需要太極劍法1000級）";

        if (me->query_skill("tianwei-zhengqi", 1) < 200)
                return "你的門派技能天威正氣還沒有修鍊到家，要多練練！  （需要天威正氣200級）";
        
        message_sort(HIY "\n$n" HIY "身形一轉，手中之劍輕靈而出，猶如碧波蕩漾，蜿蜒"
