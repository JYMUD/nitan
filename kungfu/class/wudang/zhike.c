...
void create()
{
        ...
        set("chat_msg", ({
                 ...
                 "靈虛道長說道：香火練製不易，不能隨便與人，虔誠奉獻者方能得之。\n",
                 "靈虛道長說道：我武當地靈人傑，香火鼎盛，普天下的人都來朝拜敬香。\n",
                 "靈虛道長說道：聽說山門前的松林里有異果，有砍樹的道士進去找，就再也沒有出來。\n",
        }));

        set("inquiry", ([
                "香火" : "香火練製不易，不能隨便與人，虔誠奉獻者方能得之。",
...
int accept_object(object who, object ob)
{
        ...
        if( query("money_id", ob) && ob->value() >= 100*query("age", who) )
        {
                if( (query("family/family_name", who)) == "武當派" )
                        tell_object(who,"靈虛道長哈哈一笑：既然道"+((query("gender", who) == "女性")?"姑":"兄")+"如此誠心向道，我這有新製香火一枝，請拿去供奉吧。\n");
                else
                        tell_object(who, "靈虛道長哈哈一笑：既然施主如此誠心向道，我這有新製香火一枝，請施主拿去供奉吧。\n");
