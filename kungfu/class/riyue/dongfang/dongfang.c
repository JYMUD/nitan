...
mixed ask_kuihua()
{
	...
	if (me->query_skill("kuihua-mogong", 1))
	{
        ...
        tell_object(me, HIG "\n東方不敗猛然尖嘯一聲，聲音激蕩刺耳，令人心馳神搖。你覺得胸口一震，一口鮮血噴出。\n" NOR);
...
void teach_kuihua(object me, int lv)
{
	...
	int qi;
        ...
        HIG "東方不敗長袖一拂，一道銀光划過，猛然間在你眼前一亮，你頓覺得胸口刺痛無比。\n" NOR,
        });
...
{       
        ...
        command("say 看清楚了？！");
        command("say 這招精要在於快、准、狠，對於實戰經驗較低的人可能會一招使其斃命！");
...
mixed ask_skill5()
{
        ...
        {
               command("say 你內力修為還不足，還不快下去多加修鍊。");
               return 1;
        }
