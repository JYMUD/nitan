...
void create()
{
        ...
        set("no_teach", ([
                "emei-jiuyang" : "這峨嵋九陽功乃殘缺不全的九陽神功，臨濟十二庄"
                "勝之千倍，你還是學它好了。",
        ]));
...
string ask_for_quit()
{
        ...
        return "你好好的給我安心修鍊，以後降妖除魔，別天天滿腦子不正經。\n";
}
