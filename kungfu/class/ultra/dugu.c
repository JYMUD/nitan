...
int accept_object(object who, object ob)
{
        ...
        if( query("money_id", ob) )
        {
                ...
                delete("quest_dg", who);
                tell_object(who,"獨孤求敗盯着" + ob->name(1) + "注視良久，嘆氣道：那你這個任務不做就算了吧。\n");
                destruct(ob);
                return 1;
        }
        ...
        if(questdg["type"]=="送")
        {
                ...
                {
                        write("獨孤求敗接過來一看，驚訝的說：“我不是叫你幫我送東西了么，你是不是記錯了？”\n");
                        return 0;
                }
                ...
                {
                        write("獨孤求敗接過來一看，生氣的說：“這張回執是你自己得到的么？別想來糊弄我！”\n");
                        return 0;
                }
        }
...
int give_up()
{
        ...
        */
                ...
                write("獨孤求敗和顏悅色地看着你，道：“沒關係，你現在根本就沒有任務啊！”\n");
        delete("quest_dg", ob);
