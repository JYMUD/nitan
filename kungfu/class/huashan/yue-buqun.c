...
int do_xunshan()
{
        ...
        if( query_temp("xunshan", me) )
        {
               ...
               {
                        message_vision("$N對着$n說：你朝陽峰沒去看看？"
                                       "這算巡的什麼山？\n", this_object(), me);
                        return 1;
               }
               if( !query_temp("xunshan/lianhua", me) )
               {
                        message_vision("$N對着$n說：你蓮花峰沒去看看？"
                                       "這算巡的什麼山？\n", this_object(), me);
                        return 1;
               }
               if( !query_temp("xunshan/yuntai", me) )
               {
                        message_vision("$N對着$n說：你雲台峰沒去看看？這算"
                                       "巡的什麼山？\n", this_object(), me);
                        return 1;
               }
               if( !query_temp("xunshan/sheshen", me) )
               {
                        message_vision("$N對着$n說：你怎麼沒去捨身崖？這算"
                                       "巡的什麼山？\n", this_object(), me);
                        return 1;
               }
               if( !query_temp("xunshan/siguo", me) )
               {
                        message_vision("$N對着$n說：你到了思過崖去了？這算"
                                       "巡的什麼山？\n", this_object(), me);
                        return 1;
               }
               if( !query_temp("xunshan/yunu", me) )
               {
                        message_vision("$N對着$n說：你到玉女峰後面華山小築"
                                       "去看過了？這算巡的什麼山？\n",
                                       this_object(), me);
                        return 1;
                }
                message_vision("$N對着$n說：不錯，辛苦了。你這就去"
                               "休息去吧。\n", this_object(), me);
        ...
        else
        {
               ...
               {
                        message_vision("$N對着$n說：今天已經有人巡山"
                                     "去了。你明天再來吧。\n", this_object(), me);
                        return 1;
               }
               ...
               {
                        set("xunshan", date);
                        message_vision("$N對着$n說：本派弟子例當巡山。你，很好，很"
                                       "好！今天就去巡山吧。\n",
                                       this_object(), me);
...
int accept_ask(object me, string topic)
{
        ...
        case "奪命連環三仙劍" :
                ...
                {
                      command("shake");
                      command("say 劍宗以劍術為主，氣為次！你的內功修為已入了氣宗歧途，再不能修鍊劍宗劍術。");
                      return 1;
                }
                */
