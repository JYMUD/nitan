...
([        "action":"$N一招"HIY"「面無人色」"NOR"，舉起$w，獃獃地盯了一會，突然猛地一杖打向$n的$l",
        "lvl" : 20,
        "skill_name" : "面無人色"
]),
([        "action":"$N將$w頂住自己的胸膛，一端指向$n，一招"HIB"「心驚肉跳」"NOR"，大聲叫喊着沖向$n",
        "lvl" : 25,
        "skill_name" : "心驚肉跳"
]),
...
([        "action":"$N伏地裝死，一招"HIG"「窮途沒路」"NOR"，一個翻滾，身下$w往橫里打出，揮向$n的襠部",
        "lvl" : 45,
        "skill_name" : "窮途沒路"
]),
