...
([      "action" : "$N暴喝一聲，竟然使出伏魔無上的「開顯圓」，氣浪如颶風般圍着$P飛旋，炎流將$n一步步向著$P拉扯過來",
        "skill_name" : "開顯圓",
        "force" : 450,
        "lvl" : 120,
        "dodge" : -10,
...
([      "action" : "$N口念伏魔真經，鋼刀連連劈出，將$n籠罩在炙焰之下，這如刀切斧鑿般的「顯真常」氣浪似乎要將$p從中劈開",
        "skill_name" : "顯真常",
        "force" : 380,
        "lvl" : 140,
        "dodge" : -5, 
...
([      "action" : "$N虛托刀柄，一式「吉祥逝」，內力運轉，跟着全身衣物無風自動，$P身體微傾，閃電一刀，斬向$n$",
        "skill_name" : "吉祥逝",
        "force" : 500,
        "lvl" : 180,
        "dodge" : 5, 
