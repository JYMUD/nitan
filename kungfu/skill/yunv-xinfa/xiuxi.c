...
string *phases = ({
        "你正在修鍊玉女心經，真氣運行至“少陰”經“太陰”走“少陽” \n",
        "你終於功至“陽明”，頭上產生微微白氣正是內功到了火候之象！\n",
        "你修鍊玉女心經已經有了一段時候，周身白霧絲絲縷縷，漸漸集聚。\n",
...
int exert(object me)
{
    ...
    if ( k >=2 ) {
        ...
        set("qi", 50, me);
                ...
                set("eff_jing", i, me);
                return notify_fail("你體內不同內力互相衝撞，翻江倒海，難以克制。 \n"
...
int halt_xiuxi(object me)
{
        ...
        set_temp("pending/xiuxi", 0, me);
        message_vision("$N把正在運行的真氣強行壓回丹田，中止了修鍊。\n", me);
        return 1;
}