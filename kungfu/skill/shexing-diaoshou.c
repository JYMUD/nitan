...
([      "action" : "$N左掌貼於神道穴，右手一式"+(order[random(13)])+"「金蛇擺尾」"NOR"，向$n的$l划過",
        "force" : 120,
        "damage" : 280,
        "dodge" : 28,
        "lvl" : 25,
...
//			&&me!= ob
		...
		&& !me->query_temp("dsauto"))
		{
				...
				if(attack>4) attack=4;
message_vision(HIY "緊接着，$N口中發出“嘶嘶”的聲音，雙手半曲，三指上豎成蛇狀，陪合著瀟遙步法，有如急風暴雨般攻出了"+
...
&& !me->query_temp("noauto")
	...
	{
			message_vision(YEL "$N揉身而上，自左向右輕輕迴旋一周，$n被$N的身行所迷惑，頓時放棄攻擊，改為自守。\n" NOR, me,ob);
