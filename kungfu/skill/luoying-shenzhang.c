...
([      "action" : "[1;37m$N的落英神掌已修鍊至大成，一招「弧月斬」，猛然凌空飛起，當頭向$n斬去[2;37;0m",
        "force"  : 500,
        "attack" : 300,
        "dodge"  : 300,
        "parry"  : 300,
...
內力向$n涌去，頓時三丈範圍內沙石飛旋，眼見$n已無處可逃[2;37;0m",
        "force"  : 850,
        "attack" : 500,
        "dodge"  : 500,
        "parry"  : 500,
...
int valid_learn(object me)
{
        ...
        */
        ...
        if( query("str", me)<22 )
                return notify_fail("你先天臂力不足，無法修鍊落英神劍掌。\n");

        if ((int)me->query_skill("strike", 1) < 200)
                return notify_fail("你的基本掌法不夠嫻熟，無法修鍊落英神劍掌。\n");
