...
string  *msg = ({
        ...
        HIR"突然，狂風亂起，激蕩中那$w"HIR"相碰相撞，五輪歸一，合并了向$n砸去"NOR,
        ...
        HIC"猛地里$w"HIC"向$n"HIC"$l飛砸下，在$p"HIC"沉肩卸避之時，$w"HIC"又突然上飛擊出，砸向$p"HIC"的$l"NOR,
...
int valid_learn(object me)
{
        /*
        if( query("str", me)<32 )
                return notify_fail("你先天膂力不足，難以修鍊日月輪法。\n");
        */
        ...
        if ((int)me->query_skill("hammer", 1) < 100)
                return notify_fail("你的基本錘法不夠，難以修鍊日月輪法。\n");
...
mixed hit_ob(object me, object victim, int damage_bonus)
{
        ...
        &&  me->query_skill_mapped("parry") == "riyue-lun")
        {
                ...
                {
                        addn("neili", -100, me);
                        message_combatd(HIG+query("name", me)+"運勁回拉，$n臂骨喀的一聲，險些就被拉斷，劇痛之下手一松，"+
