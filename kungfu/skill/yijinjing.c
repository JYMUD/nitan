...
void skill_improved(object me)
{
        ...
        if (skill == 400)
        {
                ...
                tell_object(me, HIW "你修鍊成百毒不侵神功了。\n" NOR);
...
//內功相差太多(至少2倍以上),內力傷害全部抵消,基本上不出現
        ...
        if( random(ap/2)>dp && query("neili", me)>2000 )
        {
                ...
                if (random(10)==1) tell_object(victim, "你只覺得如同擊在金屬上，頭腦里閃過一個念頭：金屬罩！\n");
        ...
        {
                if (random(10)==1) tell_object(victim,HIY"你只覺得如同擊在金屬上，頭腦里閃過一個念頭：“金屬罩”！\n"NOR);
