...
int perform(object me, object target)
{
        ...
        message_combatd(sort_msg(HIW "忽然$N" HIW "身形激進，左手一划，右手呼的一掌"
                     "拍向$n" HIW "，力自掌生之際"
                     "說到便到，以排山倒海之勢向$n" HIW "狂涌而去，當真石"
                     "破天驚，威力無比。\n" NOR), me, target);
        ...
        if (objectp(weapon) && base_name(environment(me)) != "/d/city/biwu_dating")
        {
                ...
                {
                        addn("neili", -300, me);
                        msg = HIR "$n" HIR "只覺周圍氣流涌動，手中" + weapon->name()
                               + HIR "竟然拿捏不住，向$N" HIR "掌心脫手飛去。\n" NOR;
                        weapon->move(me, 1);
                } else
                {
                        addn("neili", -200, me);
                        msg = CYN "$n" CYN "只覺周圍氣流涌動，慌忙中連將手中"
