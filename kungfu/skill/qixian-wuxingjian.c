...
([      "action": "$N雙手向外一分，使一招「清心普善」，手若撥琴弄蕭，彈射出一股破體劍氣，直涌$n$l而去",
        "force" : 490,
        "attack": 105,
        "dodge" : 35,
        "parry" : 24,
...
([      "action": "$N手中$w向外一分，使一招「清心普善」，單手在劍身輕輕彈撥，頓時一股劍氣直涌$n$l而去",
        "force" : 250,
        "attack": 80,
        "dodge" : 10,
        "parry" : 5,
...
int valid_learn(object me)
{
        if ((int)me->query_skill("force") < 270)
                return notify_fail("你的內功火候不夠，無法修鍊七弦無形劍。\n");

        if( query("max_neili", me)<3000 )
                return notify_fail("你的內力太弱，無法修鍊七弦無形劍。\n");

        if ((int)me->query_skill("unarmed", 1) < 180)
                return notify_fail("你的基本拳腳火候不夠，無法修鍊七弦無形劍。\n");

        if ((int)me->query_skill("sword", 1) < 180)
                return notify_fail("你的基本劍法火候不夠，無法修鍊七弦無形劍。\n");

        if ((int)me->query_skill("tanqin-jifa", 1) < 100)
                return notify_fail("彈琴技法水平有限，無法修鍊七弦無形劍。\n");
