...
([        "action" : "$N一招"+HIW"「風起雲湧」"NOR+"，右腳一點，$w寒光閃閃，快速涌$n的$l",
        "lvl" : 10,
        "skill_name" : "風起雲湧",
]),
...
([        "action" : "$N一招"+HIC"「風流雲散」"NOR+"，側身而退，$w卻在胸前划出一道圓弧，橫劈$n的$l",
        "lvl" : 32,
        "skill_name" : "風流雲散",
]),
...
([        "action" : "$N一招"+HIC"「風刀霜劍」"NOR+"，只見漫天刀光閃爍，重重刀影向$n的全身涌去",
        "lvl" : 71,
        "skill_name" : "風刀霜劍",
]),
([        "action" : "$N使一招"+HIW"「風馳電掣」"NOR+"，$w舞出陣陣光影向$n的$l涌去",
        "lvl" : 86,
        "skill_name" : "風馳電掣",
]),
