...
mapping *action = ({
([        "action" : "$N使一招"+(order[random(13)])+"「春江潮水」"NOR"，雙手划了個半圈，按向$n的$l",
        "skill_name" : "春江潮水",
        "lvl" : 0
]),
...
([        "action" : "$N右手掌心向外，由右向左，使一招"+(order[random(13)])+"「灧灧隨波」"NOR"，向$n的$l打去",
        "skill_name" : "灧灧隨波",
        "lvl" : 10
]),
...
([        "action" : "$N由臂帶手，在面前緩緩划過，使一招"+(order[random(13)])+"「鴻雁長飛」"NOR"，揮向$n的$l",
        "skill_name" : "鴻雁長飛",
        "lvl" : 70
]),
...
([        "action" : "$N右掌不住向外掃出，是一式"+(order[random(13)])+"「閑潭落花」"NOR"，左掌旋轉着向$n攻去",
        "skill_name" : "閑潭落花",
        "lvl" : 85
]),
