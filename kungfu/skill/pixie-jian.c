...
([      "action":"驀地里$N猱身而上，躥到$n的身後，又躍回原地",
        "force" : 225,
        "attack": 60,
        "parry" : 35,
        "dodge" : 155,
...
([      "action":"$N一聲冷笑，驀地里疾衝上前，一瞬之間，與$n相距已不到一尺，$w隨即遞出",
        "force" : 260,
        "attack": 70,
        "parry" : 40,
        "dodge" : 165,
...
([      "action":"$N一聲冷笑，驀地里疾衝上前，一瞬之間，與$n相距已不到一尺，手指隨即刺出",
        "force" : 160,
        "attack": 70,
        "parry" : 40,
        "dodge" : 65,
...
int valid_learn(object me)
{
        if( query("character", me) == "光明磊落" ||
            query("character", me) == "狡黠多變" )
                return notify_fail("你心中暗道：這辟邪劍法損人損己，修鍊來何用。\n");
        ...
        */
        ...
        if( query("dex", me)<32 )
                return notify_fail("你先天身法孱弱，難以修鍊辟邪劍法。\n");
