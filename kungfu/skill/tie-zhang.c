...
int valid_learn(object me)
{
        ...
        if( query("str", me)<32 )
                return notify_fail("你的先天臂力孱弱，難以修鍊鐵掌掌法。\n");

        if( query("con", me)<32 )
                return notify_fail("你的先天根骨孱弱，難以修鍊鐵掌掌法。\n");

        if( query("max_neili", me)<2000 )
                return notify_fail("你的內力修為太弱，難以修鍊鐵掌掌法。\n");

        if ((int)me->query_skill("force") < 230)
                return notify_fail("你的內功火候不足，難以修鍊鐵掌掌法。\n");

        if ((int)me->query_skill("strike", 1) < 150)
                return notify_fail("你的基本掌法火候不夠，難以修鍊鐵掌掌法。\n");
