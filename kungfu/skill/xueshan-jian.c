...
([        "action": "$N一式" +(order[random(13)])+"「明月羌笛」"NOR"，$w划了一個半月弧形，灑出點點銀光，飛向$n的$l",
        "lvl" : 160,
        "skill_name" : "明月羌笛"
]),
([        "action": "$N一招" +(order[random(13)])+"「月色黃昏」"NOR"，使得若有若無，朦朦朧朧，$w斜斜划出，直取$n$l",
        "lvl" : 170,
        "skill_name" : "月色黃昏"
]),
...
([        "action": "$N長嘯一聲，身法加快，一招"+(order[random(13)])+"「暗影浮香」"NOR"，$w如梅干彎彎遞出，$n正驚疑間，\n劍上突然豪光綻放,道道劍氣向$n籠罩而去",
        "lvl" : 200,
        "skill_name" : "暗影浮香"
]),
});
