...
([      "name":   "中沖劍",
        "action": "$N將中指向上一刺，「" HIW "中沖劍" NOR "」拔地而起，接着手指向下一"
                  "劃，劍氣如利刀般砍出",
        "force" : 560,
        "attack": 145,
        "dodge" : 10,
...
([      "name":   "少沖劍",
        "action": "$N右手小指伸出，真氣自少沖穴激蕩而出，「" HIW "少沖劍" NOR "」橫生"
                  "奇變，颼的刺向$n",
        "force" : 480,
        "attack": 150,
        "dodge" : 90,
...
([      "name":   "少沖劍",
        "action": "$N掌托於胸前，伸出右小指，一招「" HIW "少沖劍" NOR "」緩緩地點向$n"
                  "的周身大穴",
        "force" : 530,
        "attack": 170,
        "dodge" : 90,
...
([      "name":   "少沖劍",
        "action": "$N一招「" HIW "少沖劍" NOR "」，劍氣迴轉無定形，竟從左側繞了過來，"
                  "點向$n",
        "force" : 530,
        "attack": 180,
        "dodge" : 90,
...
string query_parry_msg(object victim_weapon)
{
        ...
        case 2:
                return "$n六劍連出，劍氣回蕩，直割得$N眉毛削落，臉面生通，再也不能前進半分！\n";
        default:
