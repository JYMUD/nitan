...
([      "name":   "六陰鬼脈・中沖劍",
        "action": "$N將中指向上一刺，「" HIW "六陰鬼脈・中沖劍" NOR "」拔地而起，接着手指向下一"
                  "劃，劍氣如利刀般砍出",
        "force" : 560,
        "attack": 245,
        "dodge" : 110,
...
([      "name":   "六陰鬼脈・少沖劍",
        "action": "$N右手小指伸出，真氣自少沖穴激蕩而出，「" HIW "六陰鬼脈・少沖劍" NOR "」橫生"
                  "奇變，颼的刺向$n",
        "force" : 580,
        "attack": 250,
        "dodge" : 190,
...
([      "name":   "六陰鬼脈・少沖劍",
        "action": "$N掌托於胸前，伸出右小指，一招「" HIW "六陰鬼脈・少沖劍" NOR "」緩緩地點向$n"
                  "的周身大穴",
        "force" : 530,
        "attack": 270,
        "dodge" : 190,
...
([      "name":   "六陰鬼脈・少沖劍",
        "action": "$N一招「" HIW "六陰鬼脈・少沖劍" NOR "」，劍氣迴轉無定形，竟從左側繞了過來，"
                  "點向$n",
        "force" : 530,
        "attack": 280,
        "dodge" : 190,
...
int valid_learn(object me)
{
        ...
        if( query("str", me)<34 )
                return notify_fail("你只覺得自己先天臂力不足，無法繼續修鍊。\n");

        if( query("dex", me)<34 )
                return notify_fail("你只覺得自己身法不夠靈巧，無法繼續修鍊。\n");
...
mixed hit_ob(object me, object victim, int damage_bonus, int i, int attack_time)
{
           ...
           && me->query_skill("jingluo-xue", 1) >= 200)
        {
                ...
                if( userp(me) && !query_temp("liuyin-guimai/hit_msg", me) )
                        message_vision(HIW "\n霎時間$N" HIW "只覺思緒狂涌，六陰鬼脈之神力蓄勢待發，登"
                                     "時十指紛彈，此去彼來，連綿無盡。\n" NOR, me, victim);
...
string query_parry_msg(object victim_weapon)
{
        ...
        case 2:
                return "$n六劍連出，六陰鬼脈劍氣回蕩，直割得$N眉毛削落，臉面生通，再也不能前進半分！\n";
        default:
