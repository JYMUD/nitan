...
([        "action" : "$N運起內功一招"GRN"「點木生火」"NOR"，$w上帶着無比勁氣，划了一個大弧，從上而下劈向$n的$l",
        "lvl"    : 20,
        "skill_name"  : "點木生火",
]),
([        "action" : "$N手臂一沉，一招"HIM"「張弓望月」"NOR"，雙手持$w划出一道雪亮刀光，接着攔腰反切，砍向$n的$l",
        "lvl"    : 40,
        "skill_name"  : "張弓望月",
]),
...
mixed hit_ob(object me, object victim, int damage)
{
        ...
        if (random(damage) > victim->query_str()/10)
        {
                ...
                result += (["msg" : HIW "$N手中的大刀頓時化作一團火焰，激蕩的炙流竄入$n體內，$n" BLINK +
                                    HIR "鮮血" NOR + HIW "狂噴而出！\n" NOR ]);
                return result;
        }
}
