...
([ "action" :NOR"                                  "HBRED"==那一劍的驚艷=="NOR"\n"NOR+
             HIW"$N已了$w"HIW"在手，劍如流水，見風就長，劍美，劍法更美，美的像一個受寵若驚，\n"
...
([ "action" :NOR"                                  "HBRED"==那一劍的浪漫=="NOR"\n"NOR+
             HIW"$w"HIW"迎着冷月閃出愛情一般奇詭的冷芒，在冷月下浮沉了幾道寒芒，就像凄美得可以讓人\n"
            +HIW"一口逼進的鯨吞，有如劍花般的寂莫，繚繞在$n"HIW"腦里，迂迴在$n"HIW"心中，直攻入愁腸！"NOR,
               "dodge"  :         20,
               "move"   :          0,
               "damage" :        200,
               "parry"  :         10,
...
([ "action" :NOR"                                  "HBRED"==那一劍的瀟洒=="NOR"\n"NOR+
            ...
            +HIW"劍氣激蕩，凌厲無比，令$n"HIW"難以抵擋，劍氣的鋒芒砍入肌骨！"NOR,
               "dodge"  :        -20,
               "move"   :        -20,
               "damage" :        200,
               "parry"  :         20,
...
([ "action" :NOR"                                  "HBRED"==那一劍的寂寞=="NOR"\n"NOR+
            ...
            +HIW"把白晝換上黃昏的寂寞，讓$n"HIW"逐漸失去自己的感覺，而在歲月的微光里平添害怕，而且不甚快樂！"NOR,
               "dodge"  :          0,
               "move"   :          0,
               "damage" :        250,
               "parry"  :          0,
...
void lockman(object me,object victim,object weapon,int damage)
{
        ...
        && mk < 10000 && damage > 0)
        {
               ...
               if( random(mecor) >= random(victimcor))
                {
                   message_vision(CYN"劍意已奪去$n"CYN"的心志，使$n"CYN"遁入記憶的愴涼里，悲憤的不惜向自己的夢中殺去．．\n"NOR , me , victim );
...
void power_slash(object me,object victim, object weapon,int damage)
{
 ...
 victim=enemy[j];
     ...
     switch(random(4)+1)
    {
     ...
     case 4 :
     message_vision(sprintf("\n                               "HBGRN"．．情到深處無怨由．．\n"NOR),me,victim);
     message_vision(sprintf(HIW"這一劍之勢令$n無法閃躲，就像命宮裡的一顆魔星，八字里註定了那麼一劍攔在命運里．．\n"NOR),me,victim);
     break;
    }
     COMBAT_D->report_status(victim);
    }
...
message_vision(sprintf(MAG"                       --<<紫>>劍意有如追憶思．酒入愁腸．化作相思淚\--\n"NOR),me,victim);
     ...
     if( sk > random(30)+100)
     {
message_vision(sprintf(HIC"$n被$N的七色劍意所困，全身上下傷痕纍纍！\n"NOR),me,victim);
...
message_vision(sprintf(HIY"$N心煩意亂，念念不忘，使出"HIR"忘棄紅塵"HIW"之"+NOR+""+GRN+"「扣心弦”"+NOR+""+HIY+"，刀勢如惋傷般緊扣$n！\n"NOR),me,victim);
     break;
     case 3:
message_vision(sprintf(HIY"$N心力交悴，悵然若失，使出"HIR"忘棄紅塵"HIW"之"YEL"「碎心聲”"+NOR+""+HIY+"，刀勢如凄愴般席捲$n！\n"NOR),me,victim);
     break;
     case 4:
...
message_vision(sprintf(HIY"$N心如死灰，情至義盡，使出"HIR"忘棄紅塵"HIW"之"HIB"「葬心曲”"+NOR+""+HIY+"，刀勢如怒濤般湧向$n！\n"NOR),me,victim);
     break;
     case 7:
message_vision(sprintf(HIY"$N心有餘悸，恨海難填，使出"HIR"忘棄紅塵"HIW"之"HIC"「余心韻”"+NOR+""+HIY+"，刀勢如悲涼般牽引$n！\n"NOR),me,victim);
     break;
     case 8:
    ...
    if( (query("force", me)>300) && query("force_factor", me) && query("bellicosity", me)<200 && damage>0 )
    {
       ...
       for(i=1;i<=3;i++)
       {
         switch(i)
         {
            case 1:
            message_vision(HIY"\n＝＝"HIR"醉   夢"HIY"＝＝\n"NOR,me,victim);
            message_vision(HIW"刀盪刀風，刀美如夢，彩色繽紛，絕美的刀光，如同驚艷遇着風華，\n空間為奇彩所充滿，"
