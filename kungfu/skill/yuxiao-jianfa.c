...
([        "action" : "$N回身低首，神色黯然，一招"+(order[random(13)])+"「聞聲哀怨斷人腸」"NOR"，$w劍尖游移不定地刺向$n的$l",
        "lvl" : 70,
        "skill_name" : "聞聲哀怨斷人腸"
]),
([        "action" : "$N坐手掩面，一招"+(order[random(13)])+"「彼將離兮淚漣漣」"NOR"，右手$w斜向下划出，$n微覺奇怪，正遲疑間，卻見$N手中的$w已反挑而上，直刺自己的咽喉",
        "lvl" : 80,
        "skill_name": "彼將離兮淚漣漣"
]),
