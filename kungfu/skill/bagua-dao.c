...
([      "action" : "$N一招「朝陽刀」，左右腿虛點，$w一提一收，划出一個大平十字，揮向$n的頸部",
        "force"  : 231,
        "attack" : 55,
        "dodge"  : 73,
        "parry"  : 96,
...
([      "action" : "$N一招「上勢抱刀」，$w大開大闔，自上而下划出一個大弧，筆直劈向$n",
        "force"  : 268,
        "attack" : 66,
        "dodge"  : 88,
        "parry"  : 124,
...
([      "action" : "$N藏刀內收，一招「下勢撩刀」，刀鋒自下而上划了個半弧，向$n的$l揮去！\n"
                   "$n只覺眼前一片流光般的刀影，向自己全身涌去，退後欲避，又覺一陣寒氣直逼過來",
        "force"  : 272,
        "attack" : 67,
        "dodge"  : 94,
        "parry"  : 133,
...
mapping query_action(object me, object weapon)
{
        ...
        case 4:
                ...
                break;
        case 5:
                return ([ "action": WHT "接着$N" WHT "一聲長嘆，依照八卦方位施"
