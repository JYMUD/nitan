...
string *parry_msg = ({
         ...
         "$p$W交左手，在身前划了兩個圓圈，$P見$p劍勁連綿，護住全身，竟無半分空隙。\n",
...
string *taiji_msg = ({
         ...
         "$N左手$w緩緩向前划出，成一弧形。$n只覺一股森森寒氣，直逼過來",
...
([      "action" : "$N一招"+(order[random(13)])+"「燕子掠波」"NOR"，$w自上而下划出一個大弧，平平地向$n的$l揮
去",
        "lvl" : 19,
        "skill_name" : "燕子掠波"
]),
...
([      "action" : "$N一招"+(order[random(13)])+"「青龍出水」"NOR"，$w自下而上划出一個大弧，平平地揮向$n的$l",
        "lvl" : 39,
        "skill_name" : "青龍出水"
]),
([      "action" : "$N使出"+(order[random(13)])+"「三環套月」"NOR"，$w划出三個圓圈，劍鋒直出，綿綿不斷劃向$n
的$l",
        "lvl" : 44,
        "skill_name" : "三環套月"
]),
([      "action" : "$N一招"+(order[random(13)])+"「風卷荷葉」"NOR"，$w輕靈地划出幾個圓弧，迅速地向$n的$l揮去",
        "lvl" : 49,
        "skill_name" : "風卷荷葉"
]),
([      "action" : "$N一招"+(order[random(13)])+"「虎抱頭」"NOR"，$w划出一個左低右高的大弧，斜斜地斬向$n的$l",
        "lvl" : 54,
        "skill_name" : "虎抱頭"
]),
([      "action" : "$N使出"+(order[random(13)])+"「獅子搖頭」"NOR"，$w由右向左划出一個大８字，將$n圈在其中",
        "lvl" : 59,
        "skill_name" : "獅子搖頭"
]),
...
([      "action" : "$N一招"+(order[random(13)])+"「順水推舟」"NOR"，$w自上而下划出一個大弧，平平地向$n的$l揮
去。",
        "lvl" : 94,
        "skill_name" : "順水推舟"
]),
...
([      "action" : "$N一招"+(order[random(13)])+"「挑簾式」"NOR"，$w自下而上徐徐划出一個大弧，平平地向$n的$l
揮去",
        "lvl" : 109,
        "skill_name" : "挑簾式"
]),
([      "action" : "$N一招"+(order[random(13)])+"「黃蜂入洞」"NOR"，$w自上而下划出一個大弧，平平地向$n的$l揮
去",
        "lvl" : 114,
        "skill_name" : "黃蜂入洞"
]),
...
int valid_learn(object me)
{
        ...
        if ((int)me->query_skill("sword", 1) < 100)
                return notify_fail("你的基本劍法水平有限，無法修鍊太極劍法。\n");
...
//////// 附加雙擊 yun taiji後的雙擊/////
        ...
        {
                return ([
                        "action" : HIW"突然之間，$N劍交右手，寒光一閃，向$n$l划出，這一下快速無倫"NOR,
                ...
                query_temp("raozhi_attack", me) )
        {
                switch(query_temp("raozhi_attack", me) )
                {
                        case 1: msg =HIY"不料錚的一聲輕響，$w"+HIY+"反彈過來，直刺向$p$l"NOR;
                                break;
                        case 2: msg =HIC"誰知$N於$w"HIC"上連催兩重勁，劍彎成弧，又是一彎，便如長蛇之游，奇詭不可設想"NOR;
                                break;
...
int taiji(object me, object victim, object weapon, int damage)
{
        ...
        if( damage == RESULT_DODGE )
        {
                ...
                else
                {
                        set_temp("double_attack", 1, me);
                        COMBAT_D->do_attack(me,victim,query_temp("weapon", me));
                        message_combatd("\n$N又是劍交左手，在身前划了兩個圓圈。$n見$P劍勁連綿，護住全身，竟無半分空隙。\n"NOR,me,victim);
                }
