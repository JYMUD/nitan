...
mapping *action = ({
([      "action" : "$N使一招"+(order[random(13)])+"「攬雀尾」"NOR"，雙手划了個半圈，按向$n的$l",
        "skill_name" : "攬雀尾",
        "lvl" : 0
]),
...
([      "action" : "$N左手由胸前向下，身體微轉，划了一個大圈，使一招"+(order[random(13)])+"「摟膝拗步」"NOR"，擊向$n的$l",
        "skill_name" : "摟膝拗步",
        "lvl" : 20
]),
...
([      "action" : "$N由臂帶手，在面前緩緩划過，使一招"+(order[random(13)])+"「雲手」"NOR"，揮向$n的$l",
        "skill_name" : "雲手",
        "lvl" : 70
]),
...
mixed valid_damage(object ob, object me, int damage, object weapon)
{
        ...
        if (ap / 3 + random(ap) < dp)
        {
                ...
                {
                case 0:
                        result += (["msg" : HIC "$n" HIC "面含微笑，雙手齊出，划出了"
                                            "一個圓圈，竟然讓$N" +
                                            HIC "的攻擊全不着力。\n" NOR]);
                        break;
        ...
        if (mp >= 100)
        {
                ...
                {
                case 0:
                        result = HIY "$n" HIY "面含微笑，雙手齊出，划出了"
                                 "一個圓圈，然而$N" +
