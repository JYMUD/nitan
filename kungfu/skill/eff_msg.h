...
string eff_status_msg(int ratio)
{
        ...
        if (ratio > 30) return HIR"已經傷痕纍纍，正在勉力支撐着不倒下去。"NOR;
...
string damage_msg(int damage, string type)
{
        ...
        case "割傷":
                ...
                if( damage < 50 ) return "結果在$p$l划出一道細長的血痕。\n";
                if( damage < 100 ) return "結果「嗤」地一聲，在$n身上划出一道傷口！\n";
                if( damage < 170 ) return "結果「嗤」地一聲，在$n身上划出一道血淋淋的傷口！\n";
                if( damage < 280 ) return "結果「嗤」地一聲，在$n身上划出一道又長又深的傷口，濺得$N滿臉鮮血！\n";
        ...
        case "抓傷":     
                ...
                return "結果伴隨着$n一聲凄慘的嚎叫，直透$p$l處，連皮帶肉扯下一大塊，露出了血淋淋的骨頭！！\n";
                break;       
        default:
                if( !type ) type = "傷害";
                str =  "結果造成非常可怕的嚴重";
