...
string *dodge_msg = ({
        ...
        "$N眼前一花，卻見$n竟然已離自己有數丈之遠，卻沒見$n如何躲過自己的攻擊的n",
...
([        "action" : "$N原地一個急轉身，隨即雙手一拂，$w就飄飄忽忽地飛向$n，原來這招是『星辰游離』",
        "force":40,
        "damage": 110,
        "dodge" : 55,
        "post_action": (: call_other, "/adm/daemons/weapond", "throw_weapon" :),
...
([        "action" : "$N突然騰身向後急退，使出『星空炸雷』，雙手向前一推，手裡$w就隱隱帶着雷聲疾射向$n",
        "force":70,
        "damage": 110,
        "dodge" : -5,
        "post_action": (: call_other, "/adm/daemons/weapond", "throw_weapon" :),
...
([        "action" : "$N微微凝神，使出『"+HIY"星光萬丈"NOR+"』，身影飄忽不定，$n頓覺十分刺眼，卻見$N手裡的$w已挾着地上的沙石以及周圍的樹頁攻向自己",
        "force":100,
        "damage": 130,
        "dodge" : 65,
        "post_action": (: call_other, "/adm/daemons/weapond", "throw_weapon" :),
...
([        "action" : "$N忽然輕嘆一聲，轉身而行，$n正遲疑間，卻見眼前已儘是$w的影子，眼看無處可躲了！只怕這招就是『"+HIC"滿天星雨"NOR+"』了，$n不由大驚失色",
        "force": 88,
        "damage": 120,
        "dodge" : 70,
        "post_action": (: call_other, "/adm/daemons/weapond", "throw_weapon" :),
