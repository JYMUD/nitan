...
int exert(object me, object target)
{
          ...
          */
          ...
          return notify_fail("辟邪劍法與化功大法的修鍊方法相悖，無法同時施展化功大法和辟邪劍法！\n");
          if(me->is_busy())
                  return notify_fail("你正忙着呢,沒辦法施展化功大法! \n");

message_vision(
HIB"$N突然面色陰暗下來，乾笑幾聲，陡然加快身法，將一雙大袖舞得呼呼風響。\n"
HIG"只見$N越舞越快滿場遊走，化功大法激發出的真氣布滿$N的兩隻袖袍，象鼓足的風帆。\n"
...
void checking(int del_time,object me)
{
         ...
         int exp_div;
              ...
              me->query_skill_mapped("dodge") == "pixie-jian" )
          {
                  ...
                  message_vision(HIY "\n$N用辟邪劍法與化功大法的修鍊方法相悖，不可同時施展化功大法和辟邪劍法！！\n"NOR, me);;
                  return;
          }
...
CYN "$N冷哼一聲，黑氣騰騰的雙手已抓住$n的脈門大穴，$n疼入骨髓不由發出凄厲慘叫。\n" NOR, me, target );
                          tell_object(target, HIR "你突然覺得全身真氣自手掌奔涌而出，四肢無力，再也使不出勁來！\n" NOR);
