...
([        "action" : "$N左掌護胸，含笑一式"GRN"「小品般若」"NOR"，右手中指前後划了個半弧，輕輕一甩，點向$n$l",
        "lvl"   : 20,
        "skill_name" : "小品般若"
]),
...
([        "action" : "$N盤膝跌坐，一式"HIC"「放光般若」"NOR"，全身罡氣密布，左手握拳托肘，右手拇指直立，遙遙對着$n一捺",
        "lvl"   : 60,
        "skill_name" : "放光般若"
]),
...
([        "action" : "$N口念佛經，內息激發，衣衫漸漸脹鼓，身若金剛，便立指一式"HIY"「金剛般若」"NOR"，對着$n點去",
        "lvl"   : 150,
        "skill_name" : "金剛般若"
])
});
