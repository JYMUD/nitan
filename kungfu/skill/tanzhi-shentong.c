...
string *action_finger = ({
        ...
        "$N左掌在身前一划，右手突然穿出，中指微彈，「如來神指」！直襲$n的$l",
        "$N右臂揮動，中指連彈，在身前划了一道弧線，正是「一衣帶水」，劃向$n的前胸",
        "$N躍起在半空，雙手急揮，中指連彈，「彈指驚雷」鋪天蓋地般向$n涌去",
});

string *action_throwing = ({
        "$N中指微屈，突然彈出，一式「指點江山」，$w破空之聲甚厲，直襲$n的$l",
        "$N左掌在身前一划，右手突然穿出，中指微彈，「如來神指」！$w呼嘯着直襲$n的$l",
        "$N右臂揮動，中指連彈，數個$w在身前划了一道弧線，正是「一衣帶水」，劃向$n的前胸",
        "$N躍起在半空，雙手急揮，中指連彈，「彈指驚雷」彈出鋪天蓋地的$w，向$n涌去",
});
mapping *action = ({
([      "action" : "$N右指划了個半圈，一式"CYN"「劃天裂地」"NOR"自上而下劃向$n的全身",
        "lvl" : 0,
        "skill_name" : "劃天裂地"
]),
