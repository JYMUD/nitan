...
([      "action": HIW "$N一招「車輪劍」，$w自上而下划出一個大弧，平平地向$n的$l揮去" NOR,
        "force" : 35,
        "dodge" : 45,
        "parry" : 45,
        "lvl"   : 18,
...
([      "action": HIW "$N一招「回龍式」，$w自下而上划出一個大弧，平平地揮向$n的$l" NOR,
        "force" : 45,
        "dodge" : 65,
        "parry" : 65,
        "lvl"   : 30,
...
([      "action": HIW "$N使出「套月式」，$w划出三個圓圈，劍鋒直出，綿綿不斷劃向$n的$l" NOR,
        "force" : 45,
        "dodge" : 70,
        "parry" : 70,
        "lvl"   : 35,
...
([      "action": HIW "$N一招「捲風式」，$w輕靈地划出幾個圓弧，迅速地向$n的$l揮去" NOR,
        "force" : 50,
        "dodge" : 75,
        "parry" : 80,
        "lvl"   : 40,
...
([      "action": HIW "$N一招「抱頭式」，$w划出一個左低右高的大弧，斜斜地斬向$n的$l" NOR,
        "force" : 50,
        "dodge" : 75,
        "parry" : 80,
        "lvl"   : 45,
...
([      "action": HIW "$N使出「纏絲式」，$w由右向左划出一個大８字，將$n圈在其中" NOR,
        "force" : 55,
        "dodge" : 85,
        "parry" : 80,
        "lvl"   : 50,
