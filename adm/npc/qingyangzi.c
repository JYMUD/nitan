...
int accept_object(object me, object ob)
{
        ...
        message_vision(CYN "青子對$N" CYN "皺眉道：好象有點問題，你讓巫"
                       "師來幫你看看。\n" NOR, me);
        return 0;
}
...
int tattoo(object me)
{
        ...
        {
        case 1:
                msg = "青子走進內堂，端出一個檀木沉香盒，輕輕拈出一根銀針。";
                break;
        case 2:
                msg = "接着青子將$N的身體擺放端正，再沿着圖騰中的紋樣施針。";
                break;
        case 3:
                msg = "只見青子掌出如風，每一針皆是一沾即過，來去極為迅捷。";
                break;
        case 4:
                msg = "不多時，紋樣的輪廓已被青子勾勒出來，和圖騰分毫不差。";
                break;
        case 5:
                msg = "又一會，$N刺青上的紋樣漸漸清晰了起來，與肌膚融為一體。";
                break;
        case 6:
                msg = "你不禁感嘆青子的針法精奇，刺下千多針竟不見有血湧出。";
                break;
        case 7:
                msg = "青子接着從盒子里取出十八色瓷瓶，分取粉末放入色盤中。";
                break;
        case 8:
                msg = "青子用指甲尖輕輕挑出各色粉末，再分別彈入$N刺青之上。";
                break;
        case 9:
        ...
        case 11:
                ...
                break;
        case 12:
                msg = "青子凝視許久，點了點頭，輕輕拂去了刺青上剩餘的粉末。";
                break;
        default:
                msg = "青子對$N說道：圖騰上的紋樣已經都幫你刺好了，起身吧。";
                finish = 1;
                break;
        }
        msg += "\n";
