...
int accept_object(object me, object ob)
{
            ...
            mapp(query("private_room", me)) )
        {
                ...
                message_vision("魯班看了看$N的錢，皺眉道：你這點錢干什"
                               "么也不夠啊！\n", me);
                return 0;
        }
...
private int ask_demolish()
{
        ...
        if( query_temp("contract/luban", me) )
        {
                message_vision("魯班對$N說：你不是要建房么，怎麼還沒建"
                               "好就要拆房了？真是未雨綢繆啊！\n", me);
                return 1;
        }
        ...
        message_vision("魯班睜大了眼睛，奇怪的看着$N，過了良久才說：你"
...
private int do_finish()
{
        ...
        msg += "魯班略一沉吟，然後說道：你看看有沒有什麼問題么？若是沒"
               "有，請先交"HIR"五兩黃金的手續費。\n\n"NOR;
...
private int do_withdraw()
{
        ...
        case "拒絕":
                luban_say("唉！沒能被批准也別就打退堂鼓么，看看怎麼回"
                          "事再說么。\n");
                break;
        }
...
舉個描述的例子：“desc 小院 這裡是一間別緻的小院。”這樣就給小院添加
