...
string *quest_msg = ({
        HIW "北丑長長的出了一口氣，然後掏出一張英雄貼來遞到你面前……\n" NOR,
        HIW "北丑說道：聚賢庄這個名字，你應該不會陌生吧。\n" NOR,
        HIW "前些時候，游氏兄弟和薛神醫在江湖上廣發英雄帖，召集天下英雄豪傑共赴聚賢庄，參加武林大會。\n" NOR,
        HIW "這張帖子是給你的，但是你向來四海為家，居無定所，聚賢庄發派帖子的下人就把你的英雄貼送到我這裡來了，希望我可以找到你。\n" NOR,
...
LONG);
        ...
        set("chat_chance", 1);
        set("chat_msg",({
                CYN "北丑賊眯眯的說：天算地算不如人算，可是再怎麼算戲子我都知道。\n" NOR,
        }));
