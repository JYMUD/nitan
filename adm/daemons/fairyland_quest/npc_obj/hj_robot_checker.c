...
void create()
{
    ...
    set("long", "這是一個矇著臉面的男人，嗓音沙啞，一副神秘兮兮的樣子。\n");
...
int do_test( string arg )
{
    ...
    message_vision( "$N對着$n說道：“對"+arg+"進行測試問題。”\n", this_player(), this_object() );
    command( "ok" );
...
int do_ans( string arg )
{
    ...
    if( !arg )
    {
        message_vision("$N對着$n大聲說道：“我知道了！它根本就不在這裡！！！”\n", me, this_object() );
    ...
    message_vision("$N對着$n大聲說道：“我知道了！它的位置是 "+arg+" ！”\n", me, this_object() );
