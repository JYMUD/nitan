        ...
        */
        ...
        if( slvl == 4 )
        {
                ...
                if (arg == "tianjiao")
                {
                        ...
                        message_combatd(HIM "$N負手而力，衣裳無風而動，口中念念有詞，「天之魂」已然迸發而出！\n" NOR, me);
                        ...
                        me->start_call_out((: call_other,  __FILE__, "remove_effect", me, HIM "天之魂" NOR, 600 :), 900);
                        return 1;
                }
                if( arg == "juedai" )
                {
                        ...
                        message_combatd(HIM "$N目光如炬，渾身紫光閃現，令人不寒而慄，實乃一代天，無與抗衡！\n" NOR, me);
                        set_temp("suit_defense", 1, me);
