...
string *quest_msg1 = ({
        ...
        "雖然喬峰這廝為丐幫也曾立下汗馬功勞，但國家大義所在，丐幫也難以回護於他。\n",
        "游氏兄弟和薛神醫召開武林大會，就是為了聚眾討伐喬峰。群龍無首，大家都希望可以請到江湖上德高\n"
        "望重的前輩或者是朝廷的人來做大家的領袖，畢竟這已經不是普通的家恨，還有國讎了……\n",
...
string *quest_msg2 = ({
        ...
        "說到少林寺，再麻煩你去一趟少林寺，邀請少林寺玄慈方丈參加聚賢庄大會吧。\n",
        "我知道，玄慈方丈心裡有一些難解的結，他是不會來參加武林大會的，但如果能請到玄難大師、玄寂\n"
        "大師來聚賢庄，也能讓天下英雄有個主心骨了。畢竟，天下武功出少林嘛。\n",
});
...
int do_report()
{
        ...
        command("say 既然玄難大師和玄寂大師兩位高僧要來聚賢庄，那天下英雄就不會群龍無首了。\n");
        command("say 多謝你了，你近日如果無事，可以和聚賢庄內的英雄們結交一下。\n");
