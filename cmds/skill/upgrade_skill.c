...
int continue_uping(object me)
{
        ...
        tell_object(me,HIR"\n你繼續閉關修鍊鑽研"+to_chinese(query("upgrade", me))+"...\n"NOR);
        return 1;
}
...
int closing(object me)
{
        ...
        if (random(10) == 0)
                //tell_object(me, "閉關修鍊" + to_chinese(skill) + "中...\n");
...
閉關修鍊研究武功，只有你武功達到4600級以後才能夠閉關修鍊研究提升你的武功
的COMBAT數值，要求必須在一個安全並且可以休息的地方才能修鍊，修鍊前需要有
一百萬點潛能及六十萬體會，閉關開始以後，玩家離線以後其角色將仍然在線修行，
直到玩家中止修鍊(halt)或是潛能或體會耗盡。期間內玩家的經驗、修鍊武功、武
學修養、以及修鍊武功威力將會提升。
