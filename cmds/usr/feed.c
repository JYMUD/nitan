...
int main(object me, string arg)
{
        ...
        if (arg == "all" || arg == "ALL")
        {
                ...
                if (me->query_skill("idle-force", 1) < 500)
                        return notify_fail("你的發獃神功尚未到達宗師境界，無法施展無上養豬大法。\n");
...
如果玩家正在發獃，你有擅長養豬神功，那麼可以使用這條指令
將該玩家送進豬圈實習。每使用一次養豬大法都會耗費十點潛能
和一些精。 如果使用 all 參數，則可以將在場所有發獃人士送
入豬圈，當然，耗費的潛能會更多。
