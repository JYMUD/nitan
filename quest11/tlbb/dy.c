...
// 這裡的段譽涉及到三個場景，一個在無量玉像，一個在石屋裡，一個在大倫寺暗室里
...
void create()
{
        ...
        set("gender", "男性");
        set("age", 20);
        set("long", "這是一個青年男子，披頭散髮，赤裸着上身，下身只系著一條短褲，露出\n"
                    "了兩條大腿，臉孔略尖，眼神似乎有些發狂。\n");
...
void greeting(object me)
{
    ...
    {
		  message_vision(HIC"\n$N擠進暗室，發現一個中年男子，正炯炯有神地盯着你看，感覺不到一點被囚困的樣子。\n\n"NOR, me);                      
  ...
  if(me->query("gender")=="女性")
  {
	  if(me->query("per")>26)
	  {
		  ...
		  tell_object(me,HIC"\n你又向玉像呆望良久，這才轉頭，見東壁上刮磨平整，刻着數十行字，都是“莊子”中的句子，大都出自“逍遙遊”、“養生主”、\n"
			  "“秋水”、“至樂”幾篇，筆法飄逸，似以極強腕力用利器刻成，每一筆都深入石壁幾近半寸。文末題着一行字云：“逍遙子為秋\n"
			  "水妹書。洞中無日月，人間至樂也。”！\n"NOR);
...
void dest(object me,object ob)
{
  ...
  message_vision(HIY"$n忽然看見角落裡泥土翻飛，有三個身穿貼身緊靠的人從地里鑽了出來 \n"
		...
		+"趕緊離開吧。”眾人點頭稱是，於是范、巴、華、段譽跳下地道離開了了\n"NOR, ob, me);
  destruct(ob);
}
string askjiumozhi()
{
