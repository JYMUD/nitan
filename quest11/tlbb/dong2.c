...
void init()
{
    ...
    if(me->query_condition("killer"))
    {
       ...
       tell_object(me,HIR"跟着，不知道哪裡來的一隻神腳飛起一腳，將你一腳踢飛出去！\n"NOR);
...
{
		  tell_object(me,HIR"但見帛卷上赫然出現一個橫卧的裸女畫像，全身一絲不掛，面貌竟與那玉像一般無異。\n"+
...
{
  if(!me) return;
     tell_object(me,HIY"你贊道：“神仙姊姊這段話說得再也明白不過了。”再想：“\n"+
                       "這北冥神功是修積內力的功夫，學了自然絲毫無礙。”左手慢\n"+
                       "慢展開帛卷，突然間“啊”的一聲，心中怦怦亂跳，霎時間面\n"+
                       "紅耳赤，全身發燒。但見帛卷上赫然出現一個橫卧的裸女畫像\n"+
