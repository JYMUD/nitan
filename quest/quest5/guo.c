...
string ask_shoucheng()
{
        ...
        if( query("combat_exp", me)<100000 )
              ...
              if ((int)me->query_condition("jobshadi_limit"))
               {
                message_vision("$N對着$n搖了搖頭說：你不是正做着守城任務嗎??\n", this_object(), me);
                return "“" + RANK_D->query_respect(me) + "你快點回你的崗位上去！”\n";
               }

               if ((int)me->query_condition("guojob2_busy"))
               {
                message_vision(CYN "$N對着$n搖了搖頭說：疲憊之師不利作戰！！\n" NOR,
                            this_object(), me);
...
string ask_jianlou()
{
        ...
        {
                message_vision(CYN"$N對着$n搖了搖頭說：你的基本箭法太差了！\n"NOR,
                               this_object(), me);
        ...
        {
                message_vision("$N對着$n搖了搖頭說：你不是正做着阻擊任務嗎？？\n",
                                this_object(), me);
...
string clear_degree(string arg)
{
            ...
            (strsrch(arg, HIM " ☆ " NOR) >= 0))
        {
                ...
                arg = replace_string(arg, BLU "游擊" NOR,"");
