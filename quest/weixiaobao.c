...
//    destruct(ob);
  ...
  else
  {
    ...
    gift->set_amount(50);
    message_vision("$N笑道：這位"+RANK_D->query_respect(who)+"實在是我的得力助手，這裡有些黃金你先拿着。下去好好歇息歇息，別累壞了身子。\n" NOR,this_object()); 
