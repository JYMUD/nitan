...
string * inroad_msg = ({
        ...
        "$N奇怪地瞪着$n：“哎，你不認識路吧？去北京走這邊！”說著自顧走了。\n",
...
string *xing=({"趙","錢","孫","李","周","吳","鄭","王","馮","陳","褚","衛","蔣","沈","韓","楊","朱","秦","尤","許","何","呂","施","張","孔","曹","嚴","華","金","魏","陶","姜","戚","謝","鄒","喻","柏","水","竇","章","雲","蘇","潘","葛","奚","范","彭","郎","魯","韋","昌","馬","苗","鳳","花","方","俞","任","袁","柳","酆","鮑","史","唐","費","廉","岑","薛","雷","賀","倪","湯","滕","殷","羅","畢","郝","鄔","安","常","樂","於","時","傅","皮","卞","齊","康","伍","余","元","卜","顧","孟","平","黃","和","穆","蕭","尹","姚","邵"});
...
int do_order(string arg)
{
        ...
        if (act == "go")
        {
                ...
                if (ob->is_busy() )
                        return notify_fail(HIG"鏢車輪陷泥里了，等會吧。\n"NOR);
...
int accept_hit(object me)
{
        ...
        if (!gurad_ob = present(query("gurader_name"),environment(ob) ) )
  {
        ...
        if (me == gurad_ob)
                return notify_fail(HIR"你不想干啦？早說嘛！\n"NOR);
        else
        {
