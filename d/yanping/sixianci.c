...
void create()
{
        set("short", "四賢祠");
        set("long", @LONG
延平府名優薈萃，文風昌盛。四賢祠里供奉着楊時(yang)、羅從彥
(luo) 、李炯(li)、朱熹 (zhu)四大名儒。自楊時與游酢 (you)“程門
...
LONG );
        ...
        set("item_desc", ([
                "you" : "
    游酢，北宋著名理學家、教育家、書法家、詩人。元豐四年(1082)，與楊
時同往潁里，就學於程顥。五年，登進士。元佑八年(1093)，偕楊時赴洛陽求
教程頤。一日，程瞑目養神，二人不敢驚動，候立門外，待察覺時雪已盈尺，
留下“程門立雪”的千古美談。游酢與楊時、呂大臨、謝良佐並稱程門四大弟
子。先後創辦薦山書院、豸山草堂和皖山書院等。
　　游酢與楊時首開武夷山理學之先河。他學成南歸，於元符二年(1099)在武
...
統化。
    楊時、游酢學成南歸，程顥送別他們時說：“吾道南唉！”楊時、游酢不
負恩師的重託，選擇了武夷山做為他們傳播理學的寶地。楊時在武夷山與寓居
武夷山麓五夫里的胡安國及其子侄胡寧、胡寅、胡宏、胡憲，朱熹的岳父、老
...
里紫陽樓看望朱熹。這年，李侗應邀赴福唐(今福清市)講學，病逝福唐，葬於
延平故里，由朱熹卜築，並撰寫墓志銘。謚“文靖”。清康熙皇帝御書“靜中
氣象”匾額。傳世之作有《延平問答》等。 \n",
                "zhu" : "
