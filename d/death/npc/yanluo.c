...
void create()
{
        ...
        set("inquiry", ([
                ...
                "虎骨"     : "我正需要一根白虎的骨頭來煉鎖陽丹，怎麼，你有么？",
                "白虎骨"   : "我正需要一根白虎的骨頭來煉鎖陽丹，怎麼，你有么？",
                ...
                "地陰血脈" : "這東西可以在地府輪迴司里尋找到。…嗯…要決是‘三三逢緣’。",
                ...
                "秦廣王"   : "他和我一樣，也是陰間十王之一。",
                "陰陽塔"   : "就是西邊的那座塔，是地府里最高的建築，平時由馬面看守。",
...
mixed ask_reborn()
{
        ...
        */
        ...
        foreach( object user in all )
                if( userp(user) )
                        return notify_fail("你先把你身上背着的人放下來再說。\n");
