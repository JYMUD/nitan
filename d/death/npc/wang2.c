...
void create()
{
        ...
        set("gender", "男性");
        set("age", 475);
        set("long", "王方平本是山中道士，後在豐都山修鍊成仙，御封「鬼王」。\n");
        ...
        */
        set("inquiry", ([
                "鎖陽丹" : "鎖陽丹乃地獄神品，只有牛頭王懂得製作，不過沒有本王的允許他也不敢擅自製作鎖陽丹。\n",
...
{                       
        ...
        {               
                if( query("can_perform/badao/can_xiong", me) )
                {
                        ...
                        command("say 多謝閣下仗義相助，了卻本王的心愿。");
                        return 0;
                }
                command("nod"+query("id", me));
                command("say 既然你能幫我找到神血清，我也會履行我的諾言。");
                command("ke");
            ...
            base_name(obj) == "/clone/armor/jinlan-jiasha")
        {
                ...
                command("tan");
                command("say 既然如此，本王心愿已了，你去找牛頭王幫你製作鎖陽丹吧。");
