...
"    在這裡你扮演着一個虛擬的角色，確切地來說你扮演的角色就是你。 和圖\n"
...
"----------------------------------------------------\n" HIC +
"註：以下的「" HIY "泥潭" HIC "」代表本遊戲「" HIY "泥潭Ⅴ" HIC "」\n\n" HIY +
...
"光明磊落者不能學習，而此種天性者卻不會使用毒技。又例，修鍊號\n"
...
"習武功或進行一些體力活動時要消耗氣血。\n\n" HIR
"    如何提高氣血？\n\n" HIM
"    隨着你年齡的增加你的氣血會增加少量，在泥潭裡累積在線 240\n"
...
"          0代表你未中過能增加該天賦的故事。\n"
"    元神：表示你通過元神的修鍊也可以增加臂力、悟性等屬性。\n\n" HIR
"    註：無論成敗，對於一種天賦，你一生只能吃十個增加天賦的仙\n"
...
"市的馬廄里輸入指令 " HIY "goto <城市ID>" HIM " 來乘坐，在馬廄輸入指令 " HIY "look paizi\n"
HIM "可查看各城市ID。\n\n" NOR;
        } else
        if (topic == "63") // 騎馬
        {
...
"--------------------------------------------------------\n" HIM +
"    通常新手由於體質較差會經常生病，這時，新手可以到揚州的藥鋪里有各種治病的\n"
"葯買，你可以根據你的病情買一些葯，吃後即可恢復正常。\n\n"
...
"--------------------------------------------------\n" HIM +
"    輕功影響着你的攻擊命中率及閃躲迴避率，如果你的輕功等級較高可以在戰鬥中有更\n"
...
"    輸入指令 i 可查看你身上的物品！\n\n" NOR;
        ...
        if( !query("newbie_quest_completed/wield", me) )
        {
                ...
                set("newbie_quest/msg", HIY"你先把兵器室里的劍拿來裝上，然後在來找我。\n"NOR, me);
                me->save();
        } // endif
        } else
        if (topic == "107") // 拜師學藝
...
"-----------------------------------------------------------------------\n" HIM +
"    每個人要成長總得不斷地學習，拜師是個人成長發展的必然階段，泥潭提供了30餘個門派供\n"
