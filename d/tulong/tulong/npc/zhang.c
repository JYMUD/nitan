...
{
        command("say 怎麼，要行兇么？在這裡恐怕由不得你！");
        return 1;
}
int accept_ansuan(object who)
{
        return notify_fail("你剛想暗算，可是只見會場里黑壓壓的擠滿了人，根本看不清楚。\n");
}
...
void biwu(object me)
{
        ...
        message_vision(HIR "\n張翠山說著緩步走到左首山峰前一堵大石壁前，吸一口氣，猛地里雙腳一撐，提身而起。\n"NOR,this_object());
        remove_call_out("biwu2");
        call_out("biwu2",8,me);
}
void biwu2(object me)
{
        message_vision(HIR "\n張翠山身形縱起丈余，跟着使出“梯雲縱”絕技，右腳在山壁一撐，一借力，又縱起兩丈。\n"NOR,this_object());
...
void biwu3(object me)
{
        ...
        message_vision(HIW "            起來向壁不停手，一行數字大如斗。\n\n" NOR, this_object());
...
void storm2(object me)
{
        ...
        message_vision(HIB "但聽得狂風呼嘯，身周儘是海水。\n" NOR,this_object());
