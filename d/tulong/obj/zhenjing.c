...
void create()
{
        ...
        "真經里記載了催心掌、九陰白骨爪、易筋鍛骨和蛇行狸翻，你可以試着研究研究。\n\n" NOR, );
        }
}
int do_du(string arg)
{
        ...
        if ( skill == "yijin-duangu" )
        {
                ...
                if( query("con", me)<30 )
                {
                        write("你研讀了一會兒，但是發現自己先天根骨不足，一時難以修鍊。\n");
                        return 1;
                }
                ...
                write("你仔細研讀九陰真經，對真經里所記載的易筋鍛骨頗有心得。\n");
                return 1;
        }
        if ( skill == "shexing-lifan" )
        {
                ...
                write("你仔細研讀九陰真經，對真經里所記載的蛇行狸翻輕功頗有心得。\n");
                return 1;
        }
        if ( skill == "cuixin-zhang" )
        {
                ...
                write("你仔細研讀九陰真經，對真經里所記載的催心掌頗有心得。\n");
                return 1;
        }
        if ( skill == "jiuyin-baiguzhao" )
        {
                ...
                write("你仔細研讀九陰真經，對真經里所記載的九陰白骨爪頗有心得。\n");
                return 1;
        }
        if ( skill == "yinlong-bian" )
        {
                ...
                write("你仔細研讀九陰真經，對真經里所記載的銀龍鞭法頗有心得。\n");
                return 1;
        }
}
