...
void create()
{
        set("short", "製藥房");
        set("long",
"這裡是唐門的煉藥房。屋中沒有什麼擺設，只是靠牆擺着三個木架，\n"
"架子上擺滿了藥瓶藥罐，屋子正中用上好的青石壘成了一個灶台一個怕有\n"
"千斤重的紫銅葯爐重重的壓在上面，讓人奇怪的是兩丈見方的屋子裡竟沒\n"
"有一個窗戶。\n"
);
        set("exits", ([
...
int do_putin(object me, object obj)
{
        ...
        {
                message_vision("唐毒一伸手打落了$N手上的" + obj->name() + "，叫到：“什麼東西就往葯爐里放。”\n", me);
        ...
        {
                message_vision("$N拿出" + obj->name() + "放進葯爐。\n", me);
                destruct(obj);
                message_vision("唐毒對着$N點了點頭，說到：“好，你乾的很好，快去休息吧。”\n", me);
