...
int give_job()
{
        ...
        {
                say("唐葯說道:“我現在沒心情給你派活，等我回製藥房再說吧！”\n");
                return 0;
        }

        if( !query_temp("tangmen/yao", me) )
                command("say “這裡沒有活能給你干，你聽誰說的？”");
        else
        {
                ...
                write("唐葯說道:“我這裡正缺一味草藥，快去葯圃給我找(zhao)一株草藥(yao)來吧！”\n");
                set_temp("yao", 1, me);
        }
        return 1;
}
...
int accept_object(object who, object ob)
{
        ...
        write("唐葯衝著你搖了搖頭，然後又小心翼翼的反弄着一株碧綠色的藥草。\n");
        return 0;
}
