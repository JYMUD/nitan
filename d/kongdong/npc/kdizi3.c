...
int do_yao(string arg)
{
        ...
        {
               message_vision("小道士對着$N搖了搖頭說：這位施主，實在對不起，\n"
                        "齋飯還沒有做好，煩請多等一會兒。\n");  
               return 1;
        }
        printf("小道士忙說：這位%s，飯還沒好，我先找給你點東西充飢吧。\n",
                (ob->query("gender")=="男性") ? "師兄" : "師姐" );
        message_vision("小道士在食櫥里翻出一塊素餅和一個葫蘆。\n",ob);
...
int accept_object(object who, object ob)
{
        if(ob->value() >= 1000)
        {
                message_vision("小道士遲疑地接過"+ob->name()+"，嘴裡嘟囔着：\n"
                "這怎麼好意思呢？\n",who);
                message_vision("小道士想了想，從食櫥里拿給&N一塊素餅和一個葫"
                        "蘆，\n說：要有人問起，你可別說是我拿給你的。\n",who);
