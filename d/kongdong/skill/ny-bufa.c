...
mapping *action = ({
    ...
    ([ "action":"$n猛的一個「神龍擺尾」，向後跳開數尺。",
       ...
       "jibie" :10,
       "sen"   :2, ]),
    ([ "action":"$n雙腳輕點，一個「白鶴衝天」，身形向上躥起數尺。",
       "lian"  :"$N雙足一點，一個「白鶴衝天」，躥起三尺來高。",
       "jibie" :20,
       "sen"   :2, ]),
    ([ "action":"$n輕飄飄地向旁邊一閃，$N的凌厲攻勢盡數落在了空里。",
       "lian"  :"$N把握住身體的平衡，藉著踢腿的力量，向旁邊一躍。",
       "jibie" :30,
       "sen"   :3, ]),
    ([ "action":"$n向高空里一縱身，躍起五尺來高。",
       "lian"  :"$N向高空里一縱身，躍起五尺來高。",
       "jibie" :40,
        "sen"  :3, ]),
