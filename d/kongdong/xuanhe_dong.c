...
void create()
{
	...
	set("long",@LONG
玄鶴洞又叫仙鶴洞，處在絕壁之上，傳說洞里有玄鶴，本是廣成子座前的仙
...
//	if (me->query("marks/kongdong/dao"))
	{
	tell_object(me,HIG"聽罷你頓起好奇心，不由得四處打探了一番，最後你的眼光落在洞口一塊突出的岩石上。\n"NOR);
	tell_object(me,HIG"何不拿這塊岩石試試新練成的胡家刀法？\n"NOR);
...
int do_perform()
{
	...
	message_vision(HIB"$N看準那塊突出的岩石,暴喝一聲，使出威震八方的絕技，繞着岩石迅速劈\n出四實四虛八刀，手中的刀如同活物。\n剎那間，漫天刀光從各個方向劈向岩石。\n"NOR,me);
