...
int do_marry(string arg) //判斷結婚
{
        ...
        if (me->is_busy())
                return notify_fail("媒婆說道：“你現在不是正忙着嗎？”\n");
...
int ready_marry(object ob,object me,object obj)//準備婚禮
{
        ...
        say("媒婆對兩位新人說道：“不要着急，我們都是很有經驗的，很快就會布置好的！”\n"
...
int start_marry(object ob,object me,object obj) //開始婚禮
{
        ...
        moon->move(room);
        message("vision", "\n隨着一陣哈哈大笑，一位紅面白須的老者，快步踱進堂中，在場的少年男女都躬身相拜：\n"
...
int do_bai(string arg)//拜堂
{
        ...
        ob = this_object();
        if (me->is_busy())
                return notify_fail("媒婆說道：“你現在不是正忙着嗎？忙完再說！”\n");
...
int do_right(object me, object ob)
{
        ...
        message("visoin", name() + "笑着對二人說：“今個兒是你們" 
                "大喜的日子，我沒有什麼禮物，只好送給你" 
                "們這對新人一對結婚戒指吧！”\n\n", environment(me)); 
...
delete("have_couple",         ob);
        ob->move("/d/suzhou/hongniang-zhuang");
        message_vision(HIR"伴郎伴娘擁着兩位新人，上了門口的兩頂大紅花轎，只聽轎夫們一聲“起轎！”\n"
                   "一行人吹吹打打地奔向迎賓樓......\n"NOR,me,obj);
