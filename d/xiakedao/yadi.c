...
湖底，四周全是水(water)，不時有幾條美麗的小魚從你身邊游過，四
面並無明顯出口。
LONG );
        set("item_desc",([
...
int do_swim(string arg)
{
        ...
        {
                message_vision("你游着游着，突然發現了一道石門(men)，也許你能將它推(push)開。\n", me);
                me->receive_damage("qi", 15);
                me->receive_wound("qi", 10);
        }
        else
        {
                message_vision("你游着游着，突然發現了一條鐵索(suo)從上面伸了過來。這條鐵索並無鐵鏽，可能經常有人爬上爬下(climb)。\n", me);
