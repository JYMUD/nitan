...
varargs void drool(string msg, string who)
{
        ...
        if( (strsrch(msg, "為什麽") >= 0) ) {
                if( sscanf(msg, "%*s為什麽%s", msg)==2 ) msg = "為什麽" + msg;
                switch(random(8)) {
                ...
                case 4: command("say " + who + "，知道這個問題的答案對你那麽重要麼？"); break;
        ...
        ||      (strsrch(msg, "Drooler") >= 0)) {
                ...
                case 2: command("say " + msg + "跟你有什麽關係？");     break;
                case 3: command("say 嗯 ... " + who + "說得好"); break;
                case 4: command("say " + who + "你為什麽對" + msg + "這麽有興趣？"); break;
                case 5: command("say 為什麽你認為" + msg + "？"); break;
                ...
                case 2: command("say 如果" + msg + "，我能幫你什麽忙嗎？");break
;
                ...
                switch(random(20)) {
                        case 0: command("say 為什麽說" + msg + "?"); break;
                        ...
                        case 14: command("say 我不這麽認為。"); break;
                        default:
                                break;
                }
        }
...
void greeting(object ob)
{
    ...
    message_vision("桃干仙，斜了$N一眼，突然大喊起來：“快拿酒來！”\n", ob);
...
int do_kill()
{
    object ob;
    ob = this_player();
    message_vision("桃谷六仙一擁而上，提起老拳將$N往死里打！桃根仙和桃干仙，桃枝\n",ob);
