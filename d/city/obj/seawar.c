                ...
                if(!who||who==i)
                {
                        ...
                        if(ob)
                        {
                                ...
                                case 0:
                                        ...
                                        m += "使用["HIY"place X坐標 Y坐標"NOR"]布置船隻\n";
...
//        add_action("do_help","helpboard");                // 幫助
        ...
        add_action("do_place","place");                        // 布置船隻
...
int do_place(string arg)
{
        ...
        if(!has_start||game_mode!=0)
                return notify_fail("現在不是布置船隻的時候。\n");
        ...
        if(i==SHIP_NUM)
                return notify_fail("你已經沒有空餘的船隻可以布置了。\n");
        else
        {
...
int do_fire(string arg)
{
        ...
        if(i==SHIP_NUM)
                return notify_fail("你已經沒有空餘的火力可以布置了。\n");
        else
        {
                display(player_id(id));
                if(i+1==SHIP_NUM)
