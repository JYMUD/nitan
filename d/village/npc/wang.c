...
int ask_me()
{
        ...
        {
                say(
"王小二眼露凶光，對" + this_player()->name() + "喊道：殺人不過頭點地，我已經\n"
"服了軟，你還不放過我，老子跟你拼了!\n");
                set_temp("apply/attack", 30);
                     set_temp("apply/defense", 30);
...
"不錯，雞是我偷的，你要怎麽樣！看你也是出來闖江湖的，難道\n" 
"不知江湖上誰的拳頭大誰說話？你不服氣？那好，咱倆練幾招，\n"
"要是你贏了，我馬上按雙倍價賠給老太太。而且我還另外送你點\n"
"東西。你要輸了，就給我爬着出去。怎麽着，敢不敢比劃(bihua)幾下？\n");
...
set_temp("marks/王3", 1,                                 obj);
                ...
                message("vision", obj->name() + "乖乖的趴在地上，從洞里爬了"
                        "出去。\n", environment(obj), ({obj}) );
                obj->move("/d/village/temple1");
                message("vision", obj->name() + "從洞里爬了出來。\n",
                        environment(obj), ({obj}) );
                return 1;
        }
