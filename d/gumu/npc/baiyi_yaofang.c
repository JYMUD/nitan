...
int ask_aoyao()
{
        ...
        message_vision("記着適量倒一些玉蜂蜜[pour mi]，這是我古墓聖葯的藥引。再扣好蓋子[close lip]\n",me);
        message_vision("把炭盆點燃[burn coal]，等爐火旺起來了。就可以熬藥了[aoyao]。\n",me);
        message_vision("熬藥時要隨時控制火候，還要不停攪拌，很累人的。葯熬好了之後，\n",me);
        message_vision("記得先滅了火[mie huo]再取葯[qu yao]，以免被燙傷。\n",me);
        return 1;
}