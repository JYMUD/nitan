...
//              "west"  : __DIR__"mudao06",
        ...
        set("item_desc", ([
                ...
                "westpic" : HIM"畫中兩個姑娘，一個二十五六歲，正在對鏡梳妝，畫中鏡里映出女郎容貌極美，秀眉入鬢，眼角卻隱隱帶着一層殺氣，正是古墓派師尊林朝英。另一個是十五六歲的丫鬟，手持面盆，在旁伺候，憨態可掬，滿臉稚氣，後來便成了小龍女
的師傅。\n"NOR,
...
int do_an(string arg)
{
        ...
        {
                message_vision("$N站在石門前，也不知在哪裡按了一下，石門吱吱響着，緩緩打開了。\n", me);
