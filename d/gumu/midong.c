...
去真是難如登天的了。室內只有一床一案，一縷陽光從洞頂的岩縫中
射入，室內光線明亮。牆邊有一個青石床 (bed)，與旁邊石壁的色澤
有很大不同。透過斜射的陽光，你看到石床對面牆壁上似乎刻着一些
...
int do_lianxi(string arg)
{
        ...
        {
                message_vision("$N手捏劍訣，照着壁上的圖形比划了幾次，只覺得一陣口乾舌燥。\n", me);
        }
        else
        {
                message_vision("$N手捏劍訣照着壁上圖形的姿勢比划了幾次，腦中靈光一閃似乎領悟到了什麼。\n", me);
                if (wumingskill>300)
                        return notify_fail("你照着壁上圖形比划了兩下，覺得似乎沒什麼可領悟的了。\n");
