...
void collapse(object me)
{
        ...
        if ( present(me, environment(ob)) )   
        {
                ...
                me->receive_damage("qi", 30*chop_times, "被柏樹榦砸死了");
                me->receive_wound("qi", 20*chop_times, "被柏樹榦砸死了");
        }
        else 
        {
                ...
                {
                        message_vision(HIR"正砸在$n頭上！\n"NOR, ob, inv[i]);
                        inv[i]->receive_damage("qi",30*chop_times, "被柏樹榦砸死了");
                        inv[i]->receive_wound("qi", 20*chop_times, "被柏樹榦砸死了");
                }
        }
