...
void create()
{
        ...
        set("inquiry", ([
                ...
                "here": "喜來福搖頭晃腦地說：“我們醉仙樓可是方圓幾十里的名樓，辦喜宴還得要來我們這裡。”\n",
                "宴" : (: ask_party :),
                "喜宴" : (: ask_party :),
                "席" : (: ask_party :),
                "酒席" : (: ask_party :),
...
int greeting(object me)
{
        ...
        if( query_temp("married_party", me))//新人
                write("喜老闆對你拱手道：“喜宴布置得差不多了，等客人來齊了您問我喜宴就行了！”\n");
...
int ask_party()
{
        ...
        if( query_temp("ready_to_party", ob) )
                message_vision("$N對$n不好意思的說：我這正開着一席呢，要不您明兒再來吧！\n",ob,me);
...
int do_serve()
{
        ...
        tell_room(environment(me), "“來啦！”四五個小夥計從內堂魚貫而出，一盤盤美味佳肴立刻擺上了桌。\n");
...
int do_steal(string arg)
{
        ...
        tell_object(me,"你還沒搞清楚是什麼事，就被一群捕快拖着出了醉仙樓......\n");
...
int kick(object me)
{
        ...
        message_vision("喜老闆怒喝一聲：“警告了你還不聽，看腳！”說完，喜來福一抬腿，$N大驚失色，\n"
                "卻怎麼也無法躲得過這一腳。“嗵！”地一聲，身子從窗戶里飛了出去。\n"
                "喜老福撣撣身上塵土，呵呵笑道：“沒事了，大家坐！坐！！”\n",me);
        tell_room("/d/ruzhou/xidajie","突然一個人影從西邊的醉仙樓二樓飛出來，“蓬”地重重摔在地上，細看卻是一個差點摔死的人。\n");
        set_temp("kick", 1, me);
        me->move("/d/suzhou/baodaiqiao");//移到樓下的大街房間里即可
        tell_object(me,"你只覺屁股一吃痛，身子已飛起來，“蓬”地落在地上，你的五臟六腑似乎全震蕩起來了……\n");
