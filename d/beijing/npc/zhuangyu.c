...
void create()
{
        ...
        set("noget", "庄允城嘆道：我不行了，你走吧。唉，我擔心我家裡人啊。\n");
        set("chat_chance", 5);
        set("chat_msg", ({
        "\n庄允城說道：只怪我當初好心，在書中夾了金葉送與他，\n"
        "誰想這狼心狗肺的傢伙竟然就去告發了我。唉...\n",
        "\n庄允城說道：誰要把吳之榮抓到庄府就好了。\n",
        "庄允城突然說道: 江湖威望很重要，威望高大有好處啊。\n",
        "\n庄允城嘆了口氣，說道：我知道鰲拜書房的秘密，只可惜我出不去啊。\n",
        "庄允城說道：誰要救了我，我一定把我知道的都告訴他。\n",
        }));
        set("inquiry", ([
                "吳之榮" :  "把他送到庄府去有好處。",
                "威望" :  (: ask_weiwang :),
...
say("\n庄允城說：如果你威望值很高，有些人見了你不但不會殺你，還會教你武功，送你寶貝。\n"
+"而且你還可以加入幫會，率領會眾去攻打目標，就連去錢莊取錢也會有利息 。。。。。\n");
say("庄允城又說：殺某些壞人或救某些好人可以提高江湖威望。\n");
return 1;
}
...
int accept_object(object me, object ob)
{
        ...
        {
         write(HIC "\n庄允城笑到：書里有金葉子，難道你不知道嗎？\n" NOR);
         write(HIC "庄允城說：替我把吳之榮這廝抓到庄府去吧，我不行了。\n" NOR);                
         write("庄允城喘了口氣，又說：庄府在京城東北邊。\n");
        }                
        return 1;
}
