...
"岬囪２萜旱哪廈媯豢酶嘰蟮奈嗤┦鰨Ω尚鄙歟礁盤俅執滯煬鴕\n"
"桓鑾鍇qiuqian)，一派鄉土氣息。你頓時被這裡的美景迷住了，忘了n"
"プ紡侵恍【欏n"
);
        set("exits", ([ 
        ]) );
...
int do_swing(string arg )
{
        ...
        switch (random (7)) {
                case 0:
message_vision(HIG"$N爬到鞦韆上，慢慢地開始盪起鞦韆，越盪越高。\n"NOR, me);
                break;
                case 1:
message_vision(HIG"鞦韆越盪越高，$N不由得緊緊抓住古藤。\n"NOR, me);
...
message("vision", me->name()+"似乎看到了什麼東西，匆匆地從鞦韆上跳了下來。\n", environment(me), me);
  tell_object(me, "你忽然發現前面有什麼發出耀眼的光，光一閃即失。似乎可以往北(beifang)。\n");
                ...
                break;
                case 3:
message_vision(HIR"鞦韆越盪越高，$N一不留神從鞦韆上掉了下來。\n"NOR, me);
...
tell_object(me, "＂砰！＂你重重地摔在樹根上，屁股好痛哦！ \n");
                ...
                break; 
                case 6:
message_vision(HIR"鞦韆越盪越高，$N手一滑，從鞦韆上掉了下來。\n"NOR, me);
tell_object(me, "＂砰！＂你重重地摔在樹根上，屁股好痛哦！ \n");
