...
void greeting(object ob)
{
        ...
        {
message_vision("祭祀喇嘛急急忙忙吩咐小喇嘛們往祭壇里填柴，倒酥油。\n\n", ob);
message_vision(HIR"$N點燃了祭壇中的木柴與酥油，熊熊烈火衝天而起。\n", ob);
...
message_vision(HIY"大院里光芒四起，一聲巨響過後，又恢復了平靜。超度完畢。\n"NOR, ob);
                if (exp2 > exp1)
                {
...
int accept_object(object who, object ob)
{
        ...
        {
message_vision("祭祀喇嘛笑着對$N說：這種臭東西給我有什麼用，您還是自己留着吧！\n", who);
                return 0 ;
        }
        ...
        if( query("name", ob) == "無頭屍體" )
{
        ...
        {
                message_vision("祭祀喇嘛笑着對$N說：那我們去祭壇吧！\n", who);
